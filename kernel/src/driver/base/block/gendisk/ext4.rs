...
impl super::GenDisk {
    fn convert_from_ext4_blkid(&self, ext4_blkid: u64) -> (usize, usize, usize) {
        let start_block_offset = ext4_blkid as usize * (another_ext4::BLOCK_SIZE / (1 << self.block_size_log2 as usize));
...
impl another_ext4::BlockDevice for super::GenDisk {
    ...
    fn read_block(&self, block_id: u64) -> another_ext4::Block {
        ...
        self.block_device().read_at(lba_id_start, block_count, &mut *buf)
    ...
    fn write_block(&self, block: &another_ext4::Block) {
        ...
        self.block_device().write_at(lba_id_start, block_count, &*block.data)
